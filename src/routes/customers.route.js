...
router.get('/customers',CustomersController.renderFoods);
router.get('/customers/result',CustomersController.getFoods);
router.get('/customers/submit',CustomersController.getFoodsbyBranch);
